        ...
        <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
            ...
            <div class="flex flex-col mb-4">
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                    <img src="/frontend/src/images/content/courier/logocourier1.png" alt="llink-aja"
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/courier/logocourier2.png" alt="llink-aja"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
            ...
            <div class="flex flex-col mb-4">
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logopayment1.png" alt="midtrans"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logopayment2.png" alt="gopay"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logopayment3.png" alt="ovo"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logopayment4.png" alt="link-aja"
                    />
                    </button>
                </div>
                </div>
            ...
            <div class="text-center">
                <button
                type="submit"
                class="bg-yellow-400 text-black hover:bg-black hover:text-pink-400 focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-6"
                >
                Checkout Now
                </button>
            </div>
