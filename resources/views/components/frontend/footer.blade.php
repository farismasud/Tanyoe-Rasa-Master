...
<div class="px-4 py-12 mt-16 border-t border-b border-gray-200">
    <div class="flex justify-center mb-8">
        <img src="{{ url('frontend/src/images/design/TanyoeLogo.png')}}" alt="Tanyoe Rasa - Adalah sebuah website yang menjaual beans, coffe dan pastry" />
    </div>
    <aside class="container mx-auto">
    <div class="flex flex-wrap justify-center md:space-x-4">
        <!-- START: Item aside menu 1 -->
        <div class="w-full mb-4 md:w-2/12 md:mb-0 accordion">
            <h5 class="relative mb-2 text-xl font-semibold">
                Overview
            </h5>
        ...
        <div class="w-full mb-4 md:w-2/12 md:mb-0 accordion">
            <h5 class="relative mb-2 text-xl font-semibold" id="contact">
            Contact
            </h5>
            <ul class="invisible h-0 overflow-hidden md:h-auto md:visible">
                <li>
                    <a href="https://wa.me/+6282293172712" class="block py-1 hover:underline">WhatsApp</a>
                </li>
                <li>
                    <a href="https://www.instagram.com/tanyoe_rasa/"
                    class="block py-1 hover:underline">Instagram</a>
                </li>
                <li>
                    <a href="mailto:masudfaris54@gmail.com?subject=Tanya%20Product&body=Saya%20Tertarik%20dengan%20Produk%20Anda."
                    class="block py-1 hover:underline">Email</a>
                </li>
            </ul>
        </div>
        ...
        <div class="w-full mb-4 md:w-3/12 md:mb-0">
        <h5 class="relative mb-2 text-xl font-semibold">
            Special Letter
        </h5>
        <form action="#">
            ...
            <button class="absolute right-0 p-3 text-white bg-yellow-400 rounded-xl">
...
<p class="text-sm">
    Copyright 2022 • All Rights Reserved Tanyoe Rasa
</p>
</footer>
<!-- END: Footer -->