...
<div class="container px-8 py-12 mx-auto">
    ...
    <div class="flex items-center w-56">
        <a href="{{ route('index') }}">
            <img src="{{ url('frontend/src/images/design/TanyoeLogo.png')}}"
            alt="Tanyoe Rasa - Adalah sebuah website yang menjual kopi dan kue" />
        </a>
    </div>
    ...
    <div class="w-auto">
        ...
        <li class="py-6 mx-3 md:py-0">
            <a href="{{ route('index') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Home</a>
        </li>
        <li class="py-6 mx-3 md:py-0">
            <a href="{{ route('catalog') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Catalog</a>
        </li>
        <li class="py-6 mx-3 md:py-0">
            <a href="#contact" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Contact</a>
        </li>
        <li class="py-6 mx-3 md:py-0">
            <a href="{{ route ('about') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">About</a>
        </li>
        @auth
