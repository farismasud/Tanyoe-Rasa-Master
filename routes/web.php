...
Route::get('/coffeeBeans', [FrontendController::class, 'catalog'])->name('coffeeBeans');
Route::get('/coffee', [FrontendController::class, 'coffee'])->name('coffee');
Route::get('/pastry', [FrontendController::class, 'pastry'])->name('pastry');
